...
@section('content')
    <h3 class="text-3xl font-medium text-gray-700 mb-6">Edit Category</h3>
        ...
        <form action="{{ route('admin.categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="-mx-3 md:flex mb-6">
                <div class="md:w-full px-3">
                    ...
                    <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4 mb-3" id="grid-name" type="text" name="name" value="{{ old('name', $category->name) }}" required>
                    @error('name')
            ...
            <div class="-mx-3 md:flex mb-6">
                <div class="md:w-full px-3">
                    ...
                    @if($category->image)
                        <div class="mb-2">
                            <img src="{{ asset('storage/' . $category->image) }}" alt="Current Image" class="h-20 w-20 object-cover rounded">
                        </div>
                    @endif
